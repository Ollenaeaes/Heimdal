...
def insert_inspections_batch(conn, inspections: list[dict]) -> dict:
    ...
    for record in inspections:
        try:
            ...
            # Prepare inspection row — sanitize empty strings to None for DATE columns
            row = {
            ...
            # Use savepoint so one bad record doesn't abort the whole transaction
            ...
            # Insert certificates — sanitize date fields
