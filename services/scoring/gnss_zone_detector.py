...
CLUSTER_RADIUS_WIDE_DEG = 0.5 # ~30 nautical miles — for pre-jump/jamming clustering
BUFFER_M = 5_556              # 3 nautical miles in metres
ZONE_EXPIRY_HOURS = 0.75      # How long a zone stays active (45 min)
